...
ALTER TABLE LMS_BOOKS ADD PUBLISH_YEAR NUMBER;
ALTER TABLE LMS_BOOKS ADD STATUS CHAR DEFAULT 'Y';
ALTER TABLE LMS_BOOKS ADD BOOK_NOS NUMBER DEFAULT 1 ;
ALTER TABLE LMS_BOOKS ADD CONSTRAINT UK_LMS_BOOK_TITLE UNIQUE (TITLE);
/
